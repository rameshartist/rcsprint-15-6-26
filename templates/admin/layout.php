...
<div style="margin-top:var(--hh)">
  <div class="adm-lay">
    ...
    <div class="adm-sb" id="admSidebar">
      ...
      <a href="/admin/leads" class="adm-ni <?= $cur === 'leads' ? 'act' : '' ?>"><svg viewBox="0 0 24 24"><path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4-8 5-8-5V6l8 5 8-5v2z"/></svg><span>Leads</span><b class="adm-nav-order-count" data-admin-live-count="leads"<?= $adminNewLeadCount > 0 ? '' : ' hidden' ?>><?= number_format($adminNewLeadCount) ?></b></a>
      ...
      <a href="/admin/approvals" class="adm-ni <?= $cur === 'approvals' ? 'act' : '' ?>"><svg viewBox="0 0 24 24"><path d="M9 16.17 4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/></svg><span>Approvals</span><b class="adm-nav-order-count" data-admin-live-count="approvals"<?= $adminPendingApprovalCount > 0 ? '' : ' hidden' ?>><?= number_format($adminPendingApprovalCount) ?></b></a>
      ...
      <a href="/admin/header-footer" class="adm-ni <?= $cur === 'header-footer' ? 'act' : '' ?>"><svg viewBox="0 0 24 24"><path d="M3 3h18v4H3V3zm0 7h18v11H3V10zm3 3v5h5v-5H6z"/></svg>Header &amp; Footer</a>
    ...
    (function(){
      ...
      async function pollAdminUpdates() {
        ...
        try {
          ...
          Object.entries(payload.counts || {}).forEach(([key, raw]) => {
